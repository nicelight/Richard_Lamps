...
//          РИЧАРД   !
// допишите ниже в комментарии Алгоритма работы
//свой алгоритм нового кода.
//мне это поможет и Вам в будущем.
// эти строки можете удалить, как только алгоритм допишите
//и пустые строки тоже
